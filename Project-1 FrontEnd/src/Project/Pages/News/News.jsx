        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-latest-news">
                <a href="single-news.html">
                  <div className="latest-news-bg news-bg-4"></div>
                </a>
                <div className="news-text-box">
                  <h3>
                    <a href="single-news.html">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-latest-news">
                <a href="single-news.html">
                  <div className="latest-news-bg news-bg-5"></div>
                </a>
                <div className="news-text-box">
                  <h3>
                    <a href="single-news.html">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-latest-news">
                <a href="single-news.html">
                  <div className="latest-news-bg news-bg-6"></div>
                </a>
                <div className="news-text-box">
                  <h3>
                    <a href="single-news.html">
                      Love for fruits are genuine of John Doe
                    </a>
                  </h3>
                  <p className="blog-meta">
                    <span className="author">
                    ...
                    <span className="date">
                      <i className="fas fa-calendar"></i> 27 December, 2018
                    </span>
                  </p>
                  <p className="excerpt">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
